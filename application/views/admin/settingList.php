...
<?php include 'include/header.php';
      ...
      $setting = $this->admin_common_model->get_all('setting');
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Setting </span> <!-- <a href="<?=base_url('admin/view_page/editSetting');?>"><button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a> -->
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <div class="box-body table-responsive no-padding ">
        ...
        <tbody>
           <?php $i=2; foreach($setting as $row){ 
               ...
               ?>
                ...
                <!--<td><div class="[ form-group ] mb0">
                  ...
                  <div class="row">
                    <div class="col-sm-2">
                       <?php
                        if ($row['logo'] == ''){
                          ...
                          $img_url = base_url('uploads/images/'.$row['logo']);
                        }

                        if ($row['icon'] == ''){
                          $img_url1 = base_url('uploads/images/no_image.png');
                        }else{
                          $img_url1 = base_url('uploads/images/'.$row['icon']);
                        }
                      ?>
                    ...
                    <sapn><?= $row['name']; ?>
                        <div>
                        <span><a href="<?=base_url('admin/view_page/editSetting/'.$row['id']);?>" class="cdG">Edit</a>  </span> 
                ...
                <td><p><img src="<?=$img_url1;?>" alt="" width="50"> </p></td>
               </tr>
