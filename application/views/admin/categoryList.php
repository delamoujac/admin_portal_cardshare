...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Categories </span> <a href="<?=base_url('admin/view_page/addCategory');?>"><button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a>
                ...
                <!--<td><div class="[ form-group ] mb0">
                  ...
                  <div class="row">
                    ...
                    <sapn><?= $row['category_name']; ?>
                        ...
                        <span><a href="#" class="cdG" onclick="deleteCategory('<?=$row["id"];?>')">Delete</a></span>
                        </div>
                    </sapn></div><!-- /row -->
