...
$result = $this->admin_common_model->insert_data('place_order',$arr_data); 
...
$('.confirm').click(function(){
        window.location='".base_url('admin/view_page/receivedOrders')."';
});
...
$result = $this->admin_common_model->update_data('place_order',$arr_data, $arr_where); 
//echo $this->db->last_query(); die;
