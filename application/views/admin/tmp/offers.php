...
<?php include 'include/header.php';
      ...
      $product = $this->admin_common_model->get_all('offers');
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Offers </span> <a href="<?=base_url('admin/view_page/addoffers');?>"><button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a>
               ...
               ?>
                ...
                <!--<td><div class="[ form-group ] mb0">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                    <sapn><?= $row['offer_title']; ?>
                        <div>
                        <span><a href="<?=base_url('admin/view_page/addoffers/'.$row['id']);?>" class="cdG">Edit</a> | </span>  
                        <span><a href="#" class="cdG" onclick="deleteOffers('<?=$row["id"];?>')">Delete</a></span>
                        </div>
                    </sapn></div><!-- /row -->
