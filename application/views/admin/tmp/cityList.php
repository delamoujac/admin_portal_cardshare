...
<?php include 'include/header.php';
      ...
      $category = $this->admin_common_model->get_all('kuwait_city');
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">City </span> <a href="<?=base_url('admin/view_page/addCity');?>"><button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a>
        ...
        <tbody>
           <?php $i=2; foreach($category as $row){ 
               ...
               ?>
                ...
                <td><span><?php echo $row['city_name']?></span><br>
                 <span><a href="#" class="cdG" onclick="deleteCity('<?=$row["id"];?>')">Delete</a></span></td>
...
function(){
        ...
        $.ajax({
          ...
          data: {'table': 'kuwait_city', 'id': id}, // change this to send js object
          type: "POST",
