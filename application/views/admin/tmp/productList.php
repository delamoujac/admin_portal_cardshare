...
<?php include 'include/header.php';
      ...
      $product = $this->admin_common_model->get_all('product');
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Products </span> <!--<a href="<?=base_url('admin/view_page/addProduct');?>"><button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a>
-->
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <div class="box-body table-responsive no-padding ">
        ...
        <tbody>
           <?php $i=2; foreach($product as $row){ 
               ...
               ?>
                ...
                <!--<td><div class="[ form-group ] mb0">
                  ...
                  <div class="row">
                    ...
                    <sapn><?= $row['name']; ?>
                        <div>
                        <span><a href="<?=base_url('admin/view_page/addProduct/'.$row['id']);?>" class="cdG">Edit</a> | </span>  
                        <span><a href="#" class="cdG" onclick="deleteProduct('<?=$row["id"];?>')">Delete</a></span>
                        </div>
                    </sapn></div><!-- /row -->
...
<td>
    <div class="col-sm-2">
                        <?php
                        if ($row['image1'] == ''){
                          $img_url = base_url('uploads/images/notfound.png');
                        }else{
...
<td>
    <div class="col-sm-2">
                        ...
                        if ($row['image4'] == ''){
                          ...
                          $img_url = base_url('uploads/images/'.$row['image4']);
                        }
                      ?>
                      <img src="<?=$img_url;?>" alt="" width="50"> 
                    </div><!-- col-sm-2 -->
...
function(){
        ...
        $.ajax({
         ...
         $.ajax({
          ...
          data: {'table': 'product_images', 'product_id': id}, 
          type: "POST",
          success: function(result){
         ...
         $.ajax({
          ...
          data: {'table': 'add_to_cart', 'product_id': id}, 
          type: "POST",
          success: function(result){
        ...
        $.ajax({
          url: "<?=base_url('admin/delete_data2');?>",
          data: {'table': 'fav_product', 'fav_user_id': id},
          type: "POST",
          success: function(result){
