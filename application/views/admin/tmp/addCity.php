  ...
  <div class="content-wrapper">
   ...
   <div class="col-sm-12 cdG">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text"  class="form-control" name="city_name" required value="<?=$row['city_name'];?>">
            </div>
          </div>
...
$result = $this->admin_common_model->insert_data('kuwait_city',$arr_data); 
...
$result = $this->admin_common_model->update_data('kuwait_city',$arr_data, $arr_where); 
//echo $this->db->last_query(); die;
