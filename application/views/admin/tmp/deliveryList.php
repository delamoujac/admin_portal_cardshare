...
<?php include 'include/header.php';
      ...
      $category = $this->admin_common_model->get_all('admin');
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Delivery Charges </span> 
        ...
        <tbody>
           <?php $i=2; foreach($category as $row){ 
               ...
               ?>
                ...
                <td><span><?php echo $row['delivery_charge']?></span><br>
                
                        <span><a href="<?=base_url('admin/view_page/addDelivery/'.$row['id']);?>" class="cdG">Edit</a></span>  
