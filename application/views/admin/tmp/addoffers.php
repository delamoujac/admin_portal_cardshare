...
define("SITE_URL",'http://cskwt.com/giftstore');
 ?>
  ...
  <div class="content-wrapper">
   ...
   <div class="col-sm-12 cdG">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text"  class="form-control" name="offer_title" required value="<?=$row['offer_title'];?>">
            </div>
          </div>
...
if(isset($submit)){
    ...
    $querys =  $this->db->query("SELECT * FROM users")->result_array(); //print_r($querys);
             ...
             if($querys)
             {
                 ...
                 {  
			  	 ...
			  	 $test = ios_user_notification(SITE_URL,$user_message_apk['message'], $val['ios_register_id'],$users->id);
//print_r($test);die;
...
"<script> swal(
  'Success',
  'Add Offers Successfully',
  'success'
); 

$('.confirm').click(function(){
        window.location='".base_url('admin/view_page/offers')."';
});
