...
<?php include 'include/header.php';
      ...
      $userList = $this->admin_common_model->get_where('users',['type'=>'PROVIDER']);
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Provider </span> <a href="<?=base_url('admin/view_page/addProvider');?>"><button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a>
        ...
        <tbody>
           <?php $i=2; foreach($userList as $row){ 
               ...
               ?>
                ...
                <!--<td><div class="[ form-group ] mb0">
                  ...
                  <div class="row">
                    ...
                    <sapn><?= $row['first_name']?>
                        ...
                        <span><a href="<?=base_url('admin/view_page/addProvider/'.$row['id']);?>" class="cdG">Edit</a> | </span>  
                        <span><a href="#" class="cdG" onclick="deleteProduct('<?=$row["id"];?>')">Delete</a></span>                        </div>
                    </sapn></div><!-- /row -->
                ...
                <td><select name="status" getid="<?=$row['id']?>" style="height: auto !important;">
...
<script>
	...
	$('select').change(function () {   
		...
		//alert('getId='+getId+' status='+status);
	 	$.post("<?=base_url().'admin/update_status';?>", { status: status, id: getId }, function(data){
