  ...
  <div class="content-wrapper">
   ...
   <div class="col-sm-12 cdG">
         ...
         <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="number"  class="form-control" name="mobile" value="<?=$row['mobile'];?>" maxlength="10">
            </div>
          </div>
          
                        <input type="hidden"  class="form-control" name="type" value="PROVIDER" maxlength="10">
...
$('.confirm').click(function(){
        window.location='".base_url('admin/view_page/providerList')."';
});
