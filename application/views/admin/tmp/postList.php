...
<?php include 'include/header.php';
      ...
      $postList = $this->admin_common_model->get_all('post');
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Post Details </span> <!--<a href="<?=base_url('admin/view_page/addPost');?>"><button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a>-->
    <div class="row mt10">
        ...
        <tbody>
           <?php $i=2; foreach($postList as $row){ 
               ...
               ?>
                ...
                <tr>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                    <sapn><?= $users[0]['user_name']; ?>
                        <div>
                       <!-- <span><a href="<?=base_url('admin/view_page/addNewProduct/'.$row['id']);?>" class="cdG">Edit</a> | </span>  -->
                ...
                <?php   $fetch = $this->admin_common_model->get_where('post_image',['post_id'=>$row['id']]); ?>
                <td>
                   <div class="col-sm-2">
                        <?php
                        if ($fetch[0]['image'] == ''){
                          ...
                          $img_url = base_url('uploads/images/'.$fetch[0]['image']);
                        }
                      ?>
                      <img src="<?=$img_url;?>" alt="" width="50"> 
                    </div><!-- col-sm-2 -->
...
function(){
        ...
        $.ajax({
          ...
          data: {'table': 'products', 'id': id}, // change this to send js object
          type: "POST",
