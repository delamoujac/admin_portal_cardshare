...
<?php include 'include/header.php';
      ...
      $coupon = $this->admin_common_model->get_all('coupon');
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Coupon </span> <a href="<?=base_url('admin/view_page/addCoupon');?>"><button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a>
        ...
        <tbody>
           <?php $i=2; foreach($coupon as $row){ 
               ...
               ?>
                ...
                <td><span><?php echo $row['code']?></span><br>
                 <span><a href="<?=base_url('admin/view_page/addCoupon/'.$row['id']);?>" class="cdG">Edit</a> | </span>  
                 <span><a href="#" class="cdG" onclick="deleteCoupon('<?=$row["id"];?>')">Delete</a></span></td>
                <td><span><?php echo $row['type']. "%"; ?></span><br>
                <td><span><?php echo $row['usable']?></span><br>
               </tr>
...
function(){
        ...
        $.ajax({
          ...
          data: {'table': 'coupon', 'id': id}, // change this to send js object
          type: "POST",
