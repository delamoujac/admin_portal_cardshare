...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Users List </span> <a href="<?=base_url('admin/view_page/addUser');?>"><button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a>
               ...
               ?>
                ...
                <!--<td><div class="[ form-group ] mb0">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                    <sapn><?= $row['first_name']?><?= $row['last_name']?>
                        <div>
                          

                      <span><a href="<?=base_url('admin/view_page/addUser/'.$row['id']);?>" class="cdG">Edit</a> | </span>  
                        <span><a href="#" class="cdG" onclick="deleteUsers('<?=$row["id"];?>')">Delete</a></span>                      </div>
                    </sapn></div><!-- /row -->
                ...
                <td><p><?= $row['date_time']; ?></p></td>
                  <td><p class="pull-right">
                      <?php if($row['status']=="Active"){ ?>
                         <a href="<?=base_url('admin/status/'.$row['id'].'?status=Deactive');?>" class='btn btn-success'><?= $row['status']; ?></a>
                      <?php }else{ ?>
                         <a href="<?=base_url('admin/status/'.$row['id'].'?status=Active');?>" class='btn btn-danger'><?= $row['status']; ?></a>
                      <?php } ?>
                   </p></td>
               </tr>
